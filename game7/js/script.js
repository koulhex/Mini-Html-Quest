...
let datacount = 0;
let data = [
        ["Make a word: a) eaakrt b) uojd c) cyincgl", "GO or Play: a) bowling b) snowboarding c)volleyball", "GO or Play: a) skiing b)baseball c) cycling ", "DO or Play: a) chess b) judo c) karate", "Name 3 water sports", "Name 3 team sports", "Name 3 individual sports", "What sports games do you know which are played with a ball?", "What sport need transport?", "What port do you like to watch?", "Make a sentence: you/a/Did/watch/football/match/yesterday", "Make a sentence: it/yesterday/Did/rain", "True or false: Christopher Columbus discovered America.", "True or false: Dinosaur lived 2 hundred year ago.", "True or false: It didn’t rain yesterday.", "Name 3 things people wear when it is hot.", "Name 3 thing people wear when it is cold.", "Name 3 thing people wear if they do sport.", "What is the most popular in your grade: hoodie or jeans?", "Do you have to wear a school uniform?", "What Kazakh national games do you know?", "What is the most popular game in your country?", "What are the most dangerous sports? Why?"] 
        ];
